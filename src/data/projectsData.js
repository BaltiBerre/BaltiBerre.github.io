const projectsData = [
    {
      ...
      description: "A comprehensive electronic medical records system with role-based access for patients, doctors, and administrators. Features include appointment scheduling, medical record tracking, and administrative oversight.",
      pmHighlights: [
        "Designed structured workflows for role-based access, modeling real-world user coordination",
        "Created project backlog and timeline across four core modules",
        "Maintained task flow through completion with clear documentation",
        "Applied security protocols (access control, audit logging) to support compliance",
        "Held monthly review meetings with pre-med students, presenting progress and gathering feedback"
      ],
      skills: [
    ...
    // },
    {
      ...
      description: "A research project analyzing software update behaviors in the Maven ecosystem, with a focus on understanding how dependencies impact project health and stability over time.",
      pmHighlights: [
        "Led end-to-end execution of research project from technical design to delivery",
        "Owned data modeling and implementation using Neo4J and Cypher",
        "Synthesized findings with collaborators to uncover trends in versioning and dependency impact",
        "Presented insights at MSR 2025 co-located with ICSE, informing future tooling considerations"
      ],
      skills: [
